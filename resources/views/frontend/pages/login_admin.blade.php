...
{{--            <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                @endif
                <h4>Hello! Admin</h4>
                <h6 class="font-weight-light">Đăng nhập để tiếp tục vào Trang quảng trị</h6>
                <form action="login_admin" method="post" class="pt-3">
                	@csrf
                  <div class="form-group">
                    <input type="text" name="user_name" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                  </div>
                  <div class="form-group">
