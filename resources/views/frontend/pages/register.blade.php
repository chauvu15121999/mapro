    ...
    <div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth">
           ...
           <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>New here?</h4>
                <h6 class="font-weight-light">Đăng ký dễ dàng , chỉ cần vài bước</h6>
                @if(count($errors) > 0 )
                  ...
                  @endforeach
                @endif
                <form action="register.html" method="post"  class="pt-3">
                  @csrf
                  <div class="form-group">
                    <input type="text" name="user_name" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Username">
                  </div>
                  <div class="form-group">
                    <input type="email" name="Email" @if(isset($email))  value="
                      {{$email}}
                    " @endif  class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                  </div>
                  <div class="form-group">
                    <input type="password" name="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                  </div>
                  <div class="form-group">
                    <input type="password" name="passwordAgain" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="passwordAgain">
                  </div>
                  <div class="mb-4">
          ...
          <div class="col-lg-4 d-none d-lg-block">
                            <img style = "position: fixed;"  src="public/frontend/assets/images/loginImages2.png">
           </div>
          </div>
        </div>
